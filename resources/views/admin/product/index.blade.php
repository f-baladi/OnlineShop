    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                @include('partials.item_table',['count'=>$products['trash_count'],'route'=>'admin/product','title'=>__('public.product')])
            </div>
            <div class="card-body">
            ...
            {{$products['models'] -> links('pagination::bootstrap-4')}}
        </div>
    </div>
@endsection
