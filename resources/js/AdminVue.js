...
Vue.component('amazing-offers-component', require('./components/AmazingOffersComponent.vue').default);
Vue.component('pagination-component', require('laravel-vue-pagination'));
// Vue.component('cleave-component', require('vue-cleave-component'));
